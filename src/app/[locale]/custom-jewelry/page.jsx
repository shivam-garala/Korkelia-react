...
import styles from "../../custom-jewelry/page.module.css";
...
export async function generateMetadata({ params }) {
  ...
  return {
    title: isFi ? "Tilaustyöt | Korkeila Helsinki" : "Custom Jewelry | Korkeila Helsinki",
    description: isFi
      ? "Tilaustyöt ja uniikit korut Helsingissä – henkilökohtainen suunnitteluprosessi alusta loppuun."
      : "Bespoke and custom jewelry in Helsinki — a collaborative, advisor-led design process from start to finish.",
    alternates: {
      canonical: `/${locale}/custom-jewelry`,
      languages: {
        en: "/en/custom-jewelry",
        fi: "/fi/custom-jewelry",
        "x-default": "/en/custom-jewelry",
      },
    },
  };
}

export default async function LocalizedCustomJewelryPage({ params }) {
  const { locale } = await params;
