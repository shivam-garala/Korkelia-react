...
export async function generateMetadata({ params }) {
  ...
  return {
    title: isFi ? "Ota yhteyttä | Korkeila Helsinki" : "Contact Us | Korkeila Helsinki",
    description: isFi
      ? "Tervetuloa tutustumaan Helsingin myymäläämme ja laajaan kihla- ja vihkisormusten valikoimaamme."
      : "Visit our Helsinki boutique to explore our extensive collection of engagement rings, wedding bands, and fine jewelry.",
    alternates: {
          ...
          <div className={styles.content}>
            <div className={styles.info}>
              <section className={styles.block}>
                ...
                <Link className={styles.cta} href={`/${locale}/appointment`}>
