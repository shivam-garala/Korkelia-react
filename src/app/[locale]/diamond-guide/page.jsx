...
import DiamondGuideTabs from "./DiamondGuideTabs.jsx";
...
export async function generateMetadata({ params }) {
  ...
  return {
    title: isFi
      ? "Timanttiopas | Korkeila Helsinki"
      : "Diamond Guide | Korkeila Helsinki",
    description: isFi
      ? "Johdatus timanttien ainutlaatuiseen loistoon: karaatti, väri, puhtaus ja hionta."
      : "A curated guide to the brilliance of diamonds: carat, color, clarity, and cut.",
    alternates: {
      canonical: `/${locale}/diamond-guide`,
      languages: {
        en: "/en/diamond-guide",
        fi: "/fi/diamond-guide",
        "x-default": "/en/diamond-guide",
      },
    },
  };
}

export default async function LocalizedDiamondGuidePage({ params }) {
  const { locale } = await params;
    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <Container>
          ...
          <DiamondGuideTabs tabs={tabs} languageKey={locale} />
        </Container>
      </main>
