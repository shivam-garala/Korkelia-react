...
const introText = (
  <>
    ...
    jotka säilyttävät arvonsa ja kauneutensa sukupolvien ajan. Kaikki timanttisormuksemme
    suunnitellaan ja valmistetaan Suomessa, käsityönä, tarkoin valituista materiaaleista.
  </>
);
...
const faqs = [
  {
    ...
    answer: [
      ...
      "Hionta vaikuttaa siihen, kuinka kauniisti timantti taittaa valoa – hyvä hionta saa timantin säihkymään.",
      "Yhdessä nämä tekijät määrittävät timantin esteettisen laadun ja arvon – ja sitä kautta timanttisormuksen hinnan. Meiltä saat aina asiantuntevaa opastusta timantin valintaan.",
    ],
  },
  {
    question: "Voiko timanttisormuksen valmistaa vanhasta korusta?",
    answer: [
      "Kyllä voi. Monet asiakkaistamme tuovat meille vanhoja perintökoruja tai käyttämättä jääneitä sormuksia, joista suunnittelemme ja valmistamme täysin uuden, yksilöllisen timanttisormuksen.",
      "Voimme hyödyntää sekä vanhat timantit että kullan, mikä tekee sormuksesta sekä henkilökohtaisen että vastuullisen valinnan.",
      "Prosessi alkaa suunnittelukonsultaatiolla, jonka jälkeen teemme 3D-mallin ja valmistamme korun käsityönä verstaallamme Helsingissä.",
    ],
  },
  {
    question: "Onko laboratoriotimantti aito timantti?",
    answer: [
      "Kyllä – laboratoriotimantti on täysin aito timantti. Se on kemiallisesti, optisesti ja fyysisesti identtinen luonnontimantin kanssa.",
      "Ainoa ero on syntytapa: luonnontimantti muodostuu maaperässä miljoonien vuosien aikana, kun taas laboratoriotimantti kasvatetaan valvotuissa olosuhteissa muutamassa viikossa.",
              ...
              {showAllContent ? (
                <div className={styles.storyBody} id="story-content">
                  ...
                  <section className={styles.storySection}>
                    ...
                    <p className={styles.sectionCopy}>
                      Solitaire-malli, eli yksikivinen klassinen timanttisormus, on yksi
                      suosituimmista ja ikonisimmista sormusmalleista. Se korostaa yhtä
                      huolellisesti valittua timanttia, joka saa kaiken huomion.
                    </p>
                    <p className={styles.sectionCopy}>
                      Yksinkertainen ja puhdas muotokieli tekee siitä ajattoman valinnan –
                      erityisesti kihla- ja vihkisormuksena, jossa ajattomuus ja symbolinen
                      pysyvyys ovat tärkeitä.
                    </p>
                    <p className={styles.sectionCopy}>
                      Tällainen sormus istuu kauniisti monenlaiseen tyyliin ja on helppo
                      yhdistää muihin koruihin. Yksikivinen timanttisormus sopii erityisesti
                      sinulle, joka arvostat hillittyä eleganssia, selkeyttä ja klassista
                      muotoilua, joka ei koskaan mene pois muodista.
                    </p>
                    ...
                    <p className={styles.sectionCopy}>
                      ...
                      koko sormukseen ylellistä säihkettä.
                    </p>
                    <p className={styles.sectionCopy}>
                      Halo-muotoilu on täydellinen valinta silloin, kun haluat sormukselta
                  ...
                  <section className={styles.storySection}>
                    ...
                    <ul className={styles.storyList}>
                      <li>Karaatti kertoo timantin painosta ja läsnäolosta.</li>
                      <li>Väri määrittää timantin värittömyyden ja sävyn.</li>
                      <li>Puhtaus kuvaa sulkeumien näkyvyyttä ja kirkautta.</li>
                      <li>Hionta ratkaisee timantin valon ja säihkeen.</li>
                    </ul>
                  </section>
                  ...
                  <section className={styles.storySection}>
                    ...
                    <p className={styles.sectionCopy}>
                      Valkokulta on suosittu valinta erityisesti silloin, kun halutaan
                      korostaa timantin värittömyyttä ja säihkettä. Sen viileä,
                      hopeanhohtoinen sävy toimii erinomaisesti briljanttihiottujen
                      timanttien kanssa.
                    </p>
                    <h3 className={styles.storySubheading}>Keltakulta – klassinen ja lämmintunnelmainen valinta</h3>
                    <p className={styles.sectionCopy}>
                      Keltakulta on perinteinen ja ylellinen materiaali, joka huokuu lämpöä ja
                      arvokkuutta. Se tuo timanttisormukseen vintage-henkisyyttä ja
                      ajattomuutta.
                    </p>
                    <h3 className={styles.storySubheading}>Ruusukulta – pehmeän romanttinen ja erottuva</h3>
                    <p className={styles.sectionCopy}>
                      Ruusukulta tarjoaa pehmeän, romanttisen sävyn ja korostaa pastellisävyisiä
                      jalokiviä. Se on oivallinen valinta, kun haluat sormuksen, joka tuntuu
                      persoonalliselta mutta säilyttää arvokkuutensa.
                    </p>
                    <h3 className={styles.storySubheading}>
                      14 tai 18 Karaatin kulta – kestävä ja arvokas materiaalivalinta
                    </h3>
                    <p className={styles.sectionCopy}>
                      Kaikki kultasormuksemme valmistetaan joko 14 tai 18 karaatin kullasta, joka
                      tarkoittaa, että metalliseoksessa on 58,5 tai 75% puhdasta kultaa. Tämä
                      yhdistää erinomaisen kestävyyden ja ylellisen sävyn – ideaalinen yhdistelmä
                      päivittäiseen käyttään tarkoitetulle sormukselle.
                    </p>
                    <p className={styles.sectionCopy}>
                  ...
                  <section className={styles.storySection}>
                    ...
                    <p className={styles.sectionCopy}>
                      Haluatko jotain täysin omaa ja henkilökohtaista? Voimme valmistaa sinulle
                      täysin uniikin timanttisormuksen, jossa yhdistyvät juuri sinun toiveesi,
                      oikea materiaali ja oikean kokoinen timantti.
                    </p>
                    <p className={styles.sectionCopy}>
                      Valmistamme sormuksia myös vanhoista koruista, jolloin muisto säilyy
                      mukana uudessa muodossa.
                    </p>
                  </section>
                  ...
                  <section className={styles.storySection}>
                    ...
                    <p className={styles.sectionCopy}>
                      Timanttisormus voi olla myös lahja – valmistujaisiin, vuosipäivään tai
                      merkkipäivään. Valikoimastamme löydät sormuksia eri hintaluokissa ja
                      design-vaihtoehdoissa, joten sopiva valinta löytyy varmasti.
                    </p>
                  </section>
                  ...
                  <section className={styles.storySection}>
                    ...
                    <p className={styles.sectionCopy}>
                      Timanttisormuksen valinta on henkilökohtainen ja usein tunteikas prosessi,
                      jossa huomioidaan paljon enemmän kuin vain ulkonäkö tai budjetti.
                    </p>
                    <ul className={styles.storyList}>
                      <li>
                        Käden ja sormien muoto: pitkät, kapeat sormet korostuvat kauniisti
                        soikealla tai princess-hiontaisella timantilla.
                      </li>
                      <li>
                        Oma tyyli ja arjen käyttötarpeet: klassinen, moderni, vintage-henkinen
                        vai minimalistinen.
                      </li>
                      <li>
                        Materiaalivalinta: lämmin keltakulta, viileä valkokulta vai ruusukulta.
                      </li>
                      <li>
                        Timantin muoto ja koko: briljantti, ovaali, smaragdi, cushion,
                        pisara tai princess.
                      </li>
                    </ul>
                    <p className={styles.sectionCopy}>
                      Asiantunteva henkilökuntamme opastaa sinua kaikissa valintaan liittyvissä
                      vaiheissa – oli kyseessä valmiin mallin katsominen valikoimasta tai täysin
                      yksilöllisen timanttisormuksen suunnittelu. Haluamme varmistaa, että
                      jokainen asiakkaamme löytää sormuksen, joka ei ainoastaan näytä hyvältä –
                      vaan myös tuntuu oikealta.
                    </p>
                    <p className={styles.sectionCopy}>
                      Oikein valittu timanttisormus kulkee mukana läpi elämän – ja säilyttää
                      merkityksensä vuodesta toiseen.
                    </p>
                  </section>
                  ...
                  <section className={styles.calloutFinal}>
                    ...
                    <p className={styles.sectionCopy}>
                      Etsitpä sitten ajattoman kaunista kihlasormusta, merkityksellistä
                      vihkisormusta tai henkilökohtaista lahjaa, timanttisormus Korkeila
                      Helsingiltä on pysyvä osoitus rakkaudesta, tyylistä ja käsityötaidosta.
                    </p>
                    <p className={styles.sectionCopy}>
                      Jokainen sormus valmistetaan huolella, käyttäen eettisesti hankittuja
                      timantteja ja korkealaatuista 14 tai 18 karaatin kultaa, jotta koru kestää
                      aikaa yhtä arvokkaasti kuin se hetki, jota se juhlistaa.
                    </p>
                    <p className={styles.sectionCopy}>
                      Valikoimastamme löydät huolella valittuja timanttisormuksia – ja halutessasi
                      myös mahdollisuuden suunnitella oman, ainutlaatuisen sormuksen.
                    </p>
                    <p className={styles.sectionCopy}>
                      Perheyrityksemme auttaa sinua tekemään oikean valinnan, oli kyse sitten
                      valmiista mallista tai täysin yksilöllisestä toteutuksesta.
                    </p>
                    <p className={styles.sectionCopy}>
                      <a href="https://www.korkeilahelsinki.fi/" rel="noopener noreferrer" target="_blank">
